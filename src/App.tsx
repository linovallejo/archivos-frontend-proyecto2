                ...
                <Col xs={10} id="page-content-wrapper">
                    ...
                    {selectedComponent === 'gui' && (
                        <div>
                            ...
                            {selectedDisk && !selectedPartition && <PartitionList diskFileName={selectedDisk} onSelectPartition={handlePartitionSelect} />}
                            {selectedDisk && selectedPartition && !authenticated && <Login partitionId={selectedPartition} onLoginSuccess={handleLoginSuccess} onLoginFail={handleLoginFail} />}
                            {selectedDisk && selectedPartition && authenticated && <FileExplorer partitionId={selectedPartition} />}
                        </div>
                    )}
